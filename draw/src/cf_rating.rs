...
pub fn render_cf_rating(w: &CfRatingWidget, theme: Theme) -> String {
    ...
    for (i, (label, value, color)) in stats.iter().enumerate() {
        ...
        stat_svg.push_str(&format!(
            "<text x=\"{x}\" y=\"98\" \
                font-family=\"{font}\" font-size=\"24\" font-weight=\"700\" \
...
<text x="25" y="35" font-family="{font}" font-size="14" font-weight="600" fill="{title}">My Codeforces Rating</text>
<line x1="25" y1="52" x2="470" y2="52" stroke="{sep}" stroke-width="1"/>
<line x1="167" y1="58" x2="167" y2="155" stroke="{sep}" stroke-width="1"/>
<line x1="327" y1="58" x2="327" y2="155" stroke="{sep}" stroke-width="1"/>
{stat_svg}
</svg>"#,
        bg = c.bg,
        border = c.border,
