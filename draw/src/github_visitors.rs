...
pub fn render_github_visitors(w: &GithubVisitorsWidget, theme: Theme) -> String {
    ...
    let stats_svg = format!(
        "<text x=\"25\" y=\"88\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"22\" font-weight=\"700\" fill=\"{tv}\">{views}</text>\
         <text x=\"25\" y=\"104\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"11\" fill=\"{tl}\">Total Views (14d)</text>\
         <text x=\"200\" y=\"88\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"22\" font-weight=\"700\" fill=\"{tv}\">{unique}</text>\
         <text x=\"200\" y=\"104\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"11\" fill=\"{tl}\">Unique Visitors</text>",
    ...
    for (i, (repo, views)) in w.top_repos.iter().take(5).enumerate() {
        ...
        repos_svg.push_str(&format!(
            "<text x=\"25\" y=\"{y}\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"10\" fill=\"{tl}\">{repo}</text>\
             <text x=\"{rx}\" y=\"{y}\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"10\" font-weight=\"600\" fill=\"{tv}\" text-anchor=\"end\">{v}</text>",
...
pub fn render_github_commit_streak(
    ...
    let stats_svg = format!(
        "<text x=\"25\" y=\"80\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"22\" font-weight=\"700\" fill=\"{tv}\">{tc}</text>\
         <text x=\"25\" y=\"96\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"11\" fill=\"{tl}\">Total Commits</text>\
         <text x=\"160\" y=\"80\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"22\" font-weight=\"700\" fill=\"{tv}\">{cs}</text>\
         <text x=\"160\" y=\"96\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"11\" fill=\"{tl}\">Current Streak</text>\
         <text x=\"290\" y=\"80\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"22\" font-weight=\"700\" fill=\"{tv}\">{ls}</text>\
         <text x=\"290\" y=\"96\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"11\" fill=\"{tl}\">Longest Streak</text>\
         <text x=\"25\" y=\"128\" font-family=\"'Segoe UI',Ubuntu,sans-serif\" font-size=\"10\" fill=\"{tl}\">Best streak: {range}</text>",
